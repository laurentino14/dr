    ...
    <div className='flex  h-48 w-96 flex-shrink-0 rotate-90 snap-start rounded-lg'>
      ...
      <div className='w-3/4'>
        ...
        <span className='flex h-20 w-full items-center justify-end'>
          <ButtonDefault
            className='rounded-sm bg-neutral-400 px-4 py-2 font-poppins text-xs font-medium hover:bg-dark hover:text-neutral-100  hover:drop-shadow'

  ...
  return (
    <>
      ...
      <main className='pt-40 flex items-center justify-center flex-col gap-40'>
        ...
        <section className='w-full flex items-center justify-center gap-40'>
          <div className=' w-[28rem] bg-dark text-neutral-100 p-14 flex flex-col items-center justify-center gap-5 text-lg rounded-xl drop-shadow-2xl'>
            <div className='drop-shadow-2xl shadow-black  shadow-2xl rounded-full'>
              <Image
                quality={100}
                src='/83848032.jpg'
            ...
            <h1 className=' h-20 mt-3 w-full flex justify-center items-center gap-2 text-sm font-medium '>
              LUCAS{" "}
              <strong className='text-white font-bold text-xl mb-1'>
                LAURENTINO
              </strong>{" "}
              CAZEMIRO
            </h1>
            <p className=' text-sm -mt-12 font-bold text-primary'>
        ...
        <section className='w-full h-[40rem] bg-dark flex flex-col items-center justify-between '>
          ...
          <div className='w-full h-40 flex justify-center gap-20'>
            <div className='w-52 h-52 bg-white  rounded-full drop-shadow-2xl -rotate-12 flex items-center justify-center flex-col gap-4 font-bold font-raj hover:-translate-y-5 hover:-translate-x-5 transition-all cursor-pointer duration-500'>
              <BsPlusLg className='text-7xl' />
              <p>VISIBILIDADE</p>
              <p className='-mt-6'>NA COMUNIDADE</p>
            </div>
            <div className='w-52 h-52 bg-white rounded-full  drop-shadow-2xl -rotate-6 -translate-y-20 flex items-center justify-center flex-col gap-4 font-bold font-raj hover:-translate-y-24 hover:-translate-x-5 transition-all cursor-pointer duration-500'>
              <MdOutlineGroups className='text-7xl' />
              <p>ATIVIDADES</p>
              <p className='-mt-6'>EM GRUPO</p>
            </div>
            <div className='w-52 h-52 bg-white rounded-full  drop-shadow-2xl -translate-y-32 flex items-center justify-center flex-col gap-4 font-bold font-raj hover:-translate-y-40  transition-all cursor-pointer duration-500 '>
